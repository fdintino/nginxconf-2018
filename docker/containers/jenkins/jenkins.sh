...
find /usr/share/jenkins/ref/ \( -type f -o -type l \) -exec bash -c \
    '. /usr/local/bin/jenkins-support; for arg; do copy_reference_file "$arg"; done' _ {} +
...
# As argument is not jenkins, assume user want to run their own process,
